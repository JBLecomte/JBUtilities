...
Compute summarizing statisitics of a vector:
...
## compute quantiles
compute.q025_q25_q50_q75_q975(vec)

## compute min, max, sd and mean
compute.min_mean_sd_max(vec)
```

## Spaital data related function
Transform Longitude and latitude coordinates into NAD83 given the zone
```{r LongLat2NAD83}
long <- 65
lat <- -52
LongLatToNAD83(x = long, y = lat, zone = 9)
```
